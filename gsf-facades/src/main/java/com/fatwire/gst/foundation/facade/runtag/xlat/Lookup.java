...
public final class Lookup extends AbstractTagRunner
{
     ...
     * Note that this function is not appropriate when variable substitution is required
     * or when escaping is required.  However, it is a convenient shortcut for most cases.
