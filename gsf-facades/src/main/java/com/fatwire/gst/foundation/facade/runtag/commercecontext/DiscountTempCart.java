...
/**
 * @author Tony Field
 * @since 2015-08-04 11:09 PM
 */
public class DiscountTempCart extends AbstractTagRunner {
    public DiscountTempCart() {
        super("COMMERCECONTEXT.DISCOUNTTEMPCART");
    }

    public DiscountTempCart(String cart) {
        this();
        setCart(cart);
    }
