...
{
    /**
     * Get all of the parent assets in the AssetRelationTree for the specified asset.  Association name is required,
     * but expectedParentType is an optional filter argument.
     *
     * @param ics ICS context
     * @param log logger. May be null.
     * @param child child asset id
     * @param expectedParentType asset type of the parent to be returned.  If null, type of parent is irrelevant.
     * @param associationName name of association to use while looking for parents. may not be null
