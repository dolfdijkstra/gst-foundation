...
public final class IListUtils
{
    ...
    /**
     * Return a string value for a column.  Wraps the possible checked
     * exception NoSuchFieldException with an IllegalArgumentException
     *
    ...
    /**
     * Return a long value for a column.  Wraps the possible checked
     * exception NoSuchFieldException with an IllegalArgumentException
     *
     * @param list IList to interrogate
     * @param colname name of column to return
    ...
    /**
     * Return a Date value for a column.  The date must be in standard
     * JDBC date format.  Wraps possible checked exception
