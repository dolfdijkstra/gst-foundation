...
public class GetSubtype extends AbstractTagRunner
{
    ...
    public void setName(String s) { this.set("NAME", s); }

    public void setType(String s) { this.set("TYPE", s); }

    public void setObjectid(long id) { this.set("OBJECTID", Long.toString(id));}

    public void setOutput(String s) {this.set("OUTPUT", s); }

    /**
     * Get the subtype of the specified asset.  The asset does not need
     * to be loaded.
     *
