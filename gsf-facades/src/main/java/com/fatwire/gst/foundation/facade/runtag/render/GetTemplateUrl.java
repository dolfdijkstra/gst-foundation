...
public final class GetTemplateUrl extends TagRunnerWithArguments
{
    ...
    public void setAssembler(String s) { set("ASSEMBLER", s); }

    public void setAuthority(String s) { set("AUTHORITY", s); }

    public void setC(String s) { set("C", s); }

    public void setCid(String s) { set("CID", s); }

    public void setContainer(String s) { set("CONTAINER", s); }

    public void setContext(String s) { set("CONTEXT", s); }

    public void setDeptype(String s) { set("DEPTYPE", s); }

    public void setDynamic(String s) { set("DYNAMIC", s); }

    public void setFragment(String s) { set("FRAGMENT", s); }

    public void setOutstr(String s) { set("OUTSTR", s); }

    public void setPackedargs(String s) { set("PACKEDARGS", s); }

    public void setSatellite(String s) { set("SATELLITE", s); }

    public void setScheme(String s) { set("SCHEME", s); }
    ...
    /**
     * Shortcut constructor that sets intelligent default values.  Not all values are
     * required.  Site and TID/TTYPE are auto-detected if not explicitly specified.
     *
     * Outstr still needs to be set, and any nested parameters need to be set as well
     ...
     * @param variant
     */
    public GetTemplateUrl(ICS ics, String c, String cid, String tname, String wrapper, String slotname, String site, String context, String ttype, String tid, String assembler, String authority, String container, String deptype, String dynamic, String fragment, String packedargs, String satellite, String scheme, String variant)
    {
        super("RENDER.GETTEMPLATEURL");
    ...
    /**
     * Creates a GetTemplateUrl tag facade instance that is ready to execute unless any
     * parameters need to be passed (like p, for instance).
     * Note that this will auto-discover tid/ttype, and site, and it sets context to an
     * empty string.
     *
     * @param ics
     * @param c
    ...
    {
        this(ics, c, cid, tname, wrapper, slotname, null, "", null, null, null, null, null, null, null, null, null, null, null, null);
    }
}
