...
/**
 * @author Tony Field
 * @since 2015-08-04 11:11 PM
 */
public class GetRatings extends AbstractTagRunner {
    public GetRatings() {
        super("COMMERCECONTEXT.GETRATINGS");
    }
    public void setAssets(String assetlist) {
    ...
    public void setDefaultRating(int i) {
        set("DEFAULTRATING", Integer.toString(i));
    }
}
