...
public class RenderPage implements Action {
    ...
    protected void callTemplate(final AssetIdWithSite id, final String tname) {
        ...
        // typeless or not...
        String targetPagename = tname.startsWith("/") ? id.getSite() + "/" + tname : id.getSite() + "/" + id.getType() + "/" + tname;
     ...
     * By default, no override is done and the CallTemplate class determines the best call style.
     *
